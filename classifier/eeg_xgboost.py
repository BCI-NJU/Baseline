...
pre_trained_model_path='/mnt/workspace/Baseline/xgb_4s_se1.json'
...
class EEG_Xgboost:
    ...
    '''
    def __init__(self, old_data_path=lyh_data_path, pre_trained_model_path=pre_trained_model_path):
